...
<div class="page-wrapper">
    ...
    <section class="page-banner" style="background-image:url(images/background/page-banner-bg-2.jpg);">
        <div class="auto-container text-center">
            <h1>Serpyman / Sistemas de Alarmas</h1>
            <ul class="bread-crumb"><li><a href="#">Home</a></li> <li>Sistemas de Alarmas</li></ul>
        </div>
    </section>
    <!-- Page Banner -->
                    ...
                    <div class="about-upper text-center">
                        <div class="auto-container">
                             <div class="sec-title" align="left">
                                <h2>Sistemas  d<span>e Alarmas</span></h2>
                            </div>
                            <div class="sec-text wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1000ms" align="left">
                                <p style="text-align: justify;">
                                    Seguridad real y única con segmentación activa y pasiva que te permite protección siempre, apoyada por cámaras robóticas con video directo, audio de dos vías y almacenamiento en la nube.<br>

                                    SIENTASE SEGURO LAS 24 HORAS DEL DIA. VIGILA Y MONITOREA todo el día lo que sucede en tu casa, comercio o empresa por medio de este sistema no necesita estar presente para saber lo que sucede, desde la comodidad de su hogar o de cualquier lugar del mundo por medio de su móvil Tablet o celular  conectada a Internet vea las imágenes en vivo y en directo..<br>
                            ...
                            <figure class="image wow zoomIn" data-wow-delay="300ms" data-wow-duration="1000ms"><img src="img/servicios/SERVICIOS/seg_alarmas.jpg" alt=""></figure>
                        </div>
                    </div>
                </section>
            </div>
