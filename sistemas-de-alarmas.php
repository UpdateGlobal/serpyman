...
<div class="page-wrapper">
    ...
    <section class="page-banner" style="background-image:url(img/serpyman_head.png);">
        <div class="auto-container text-right">
            ...
            <ul class="bread-crumb"><li><a href="index.php">Home</a></li> <li>Sistemas de Alarmas</li></ul>
        </div>
    </section>
    <!-- Page Banner -->
                ...
                <section class="about-us-area">
                    <div class="about-upper text-center">
                        <div class="auto-container">
                            ...
                            <figure class="image wow zoomIn" data-wow-delay="300ms" data-wow-duration="1000ms"><img src="img/servicios/seg_alarmas.jpg" alt=""></figure>
                        </div>
                    </div>
                </section>
            </div>
