...
<div class="page-wrapper">
    ...
    <section class="page-banner" style="background-image:url(images/background/page-banner-bg-2.jpg);">
    	<div class="auto-container text-center">
            ...
            <ul class="bread-crumb"><li><a href="#">Home</a></li> <li>Seguridad Comercial</li></ul>
        </div>
    </section>
    <!-- Page Banner -->
                    ...
                    <div class="about-upper text-center">
                        <div class="auto-container">
                             <div class="sec-title" align="left">
                                <h2>Seguridad <span> Comercial</span></h2>
                            </div>
                            <div class="sec-text wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1000ms" align="left">
                                <p style="text-align: justify;">Actualmente es necesario que profesionales en seguridad y vigilancia comercial controlen el acceso de los clientes en los establecimientos y que velen por la seguridad del mismo, ya sea operando las cámaras de circuito cerrado o controlando el ingreso y salida de los clientes, mercadería y otros bienes de valor. <br>

                                Nuestros vigilantes se adaptan a las necesidades de cada cliente.<br> <br> 

                                Nuestro servicio de seguridad comercial se compone de:
                                <ul class="colunma1">
                                <ul class="">
                                    <li><i class="fas fa-angle-right"></i> Prevención de seguridad y vigilancia</li>
                                    ...
                                    <li><i class="fas fa-angle-right"></i> Custodia de mercadería</li>
                                    <li><i class="fas fa-angle-right"></i> Detección de robos y actos delictivos</li>
                                    <li><i class="fas fa-angle-right"></i> Monitoreo de cámaras de circuito cerrado</li>
                                </ul>
                            ...
                            <figure class="image wow zoomIn" data-wow-delay="300ms" data-wow-duration="1000ms"><img src="img/servicios/serv_comercial.jpg" alt=""></figure>
                        </div>
                    </div>
                </section>
            </div>
