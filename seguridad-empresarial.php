...
<div class="page-wrapper">
    ...
    <section class="page-banner" style="background-image:url(images/background/page-banner-bg-2.jpg);">
    	<div class="auto-container text-center">
            ...
            <ul class="bread-crumb"><li><a href="#">Home</a></li> <li>Seguridad Empresarial</li></ul>
        </div>
    </section>
    <!-- Page Banner -->
                ...
                <section class="about-us-area">
                    <div class="about-upper text-center">
                        <div class="auto-container">
                            ...
                            <figure class="image" data-wow-delay="300ms" data-wow-duration="1000ms"><img src="img/servicios/SERVICIOS/seg_empresarial.jpg" alt=""></figure>
                        </div>
