...
<div class="page-wrapper">
    ...
    <section class="page-banner" style="background-image:url(images/background/page-banner-bg-2.jpg);">
        <div class="auto-container text-center">
            ...
            <ul class="bread-crumb"><li><a href="#">Home</a></li> <li>Nuestras Politicas</li></ul>
        </div>
    </section>
    <!-- Page Banner -->
    ...
    <div class="container-fluid">
        <div class="row" style="margin-top: -75px;">
                    ...
                    <div class="about-upper text-center">
                        <div class="auto-container">
                            ...
                            <div class="sec-text wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1000ms" align="left">
                                ...
                                <b>SERPYMAM SECURITY S.A.C, </b>Empresa Peruana prestadora servicios de Vigilancia y Seguridad Privada, garantiza la   seguridad y salud en el trabajo de sus clientes internos y externos.<br><br>
                                <b>La Gerencia General de la organización se compromete:</b> <br><br>
                                <b>Promover la cultura del trabajo seguro</b>, la prevención de accidentes, enfermedades y lesiones personales, el auto cuidado individual y colectivo, a partir del control de riesgos propios de la actividad, encaminados a garantizar el bienestar de los colaboradores, proveedores, visitantes y demás partes interesadas; así como con la prevención de los riesgos locativos, mecánicos, físicos, químicos, biológicos, ergonómicos y psicosociales en concordancia con la normatividad pertinente.<br><br>
                                <b>Destinar los recursos humanos</b>, físicos y financieros necesarios para la planeación, ejecución y evaluación del Sistema de Gestión de Seguridad y Salud en el trabajo, acorde con los factores de riesgo existentes con el fin de minimizarlos y controlarlos.<br><br>
                                Nuestra organización está comprometida con el cumplimiento de los requisitos legales en materia de seguridad y salud en el trabajo vigentes en nuestro país.<br><br>
                                <b>Promover  la participación y consulta de los colaboradores</b>, en todas las acciones propias del Sistema de Gestión de Seguridad y Salud en el trabajo que genere un compromiso  individual y colectivo  de auto cuidado en cada uno de los colaboradores.<br><br>
                                </p>
            ...
            <div class="col-md-6 col-xs-12">
                ...
                <img src="img/politicas.png" alt="" class="imgpolitic img-responsive">
